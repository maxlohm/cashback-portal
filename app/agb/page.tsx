    ...
    <>
      ...
      <main className="max-w-4xl mx-auto p-6 space-y-8 text-gray-800">
        ...
        <div className="space-y-6">
          ...
          <section>
            <h2 className="text-xl font-semibold">2. Leistungen</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold">3. Registrierung und Teilnahme</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold">4. Prämien und Auszahlungen</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold">5. Influencer-Partnerprogramme</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold">6. Missbrauch und Sperrung</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold">7. Haftung</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold">8. Änderungen der Bedingungen</h2>
            <p>
